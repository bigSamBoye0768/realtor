		...
		<div className="min-h-[100vh] h-full w-full">
			...
			<div className="min-h-svh h-full pb-20">
				...
				<main className="max-w-screen-lg mark mx-auto px-4">
					<section className="pt-8">
						...
						<div className="grid grid-cols-[repeat(auto-fill,minmax(14rem,1fr))] gap-3">
							{explore.map((item, i) => (
								<div
									key={i}
									className="flex items-center flex-nowrap mark p-2 cursor-pointer hover:bg-gray-100 rounded-xl hover:scale-105 transition-all duration-300 ease-out space-x-3"
								>
									<div className="relative h-20 w-20 aspect-square">
										<Image
											src={item.img}
											alt={`${item.location} image`}
											className="rounded-xl h-20 w-20 aspect-square object-cover"
											fill
										/>
									</div>
									<div>
					...
					<section className="pt-8 mt-6">
						...
						<div className="flex flex-nowrap gap-x-6 overflow-auto no-scrollbar">
							{liveAnywhere.map((item, i) => (
								<div
									key={i}
									className="flex flex-col cursor-pointer mark group hover:bg-gray-100 rounded-xl transition-all duration-300 ease-out"
								>
					...
					<section className="mt-24 mb-4 mark relative">
						<div className="relative  h-96">
							<Image
								src="/assets/photos/2da67c1c-0c61-4629-8798-1d4de1ac9291.jpeg"
								alt="something"
						...
						<div className="absolute top-1/4 left-10">
							...
							<Button className="rounded-lg font-bold my-2 transition-all duration-200">
								Get inspired
							</Button>
						</div>
					</section>
