					...
					<div className="footerLinks__wrap flex flex-col lg:flex-row">
						<div className="footerSectionCover flex-1">
							...
							<ul className="footerSectionList flex lg:flex-col flex-wrap">
								...
								{/* <li className='basis-[100%] md:basis-[33.33333333333%]'><a href="">Supporting people with disabilities</a></li> */}
								<li className="basis-[100%] md:basis-[33.33333333333%]">
									<a href="">Cancellation options</a>
								</li>
								<li className="basis-[100%] md:basis-[33.33333333333%]">
									<a href="">Report a listing concern</a>
								</li>
							</ul>
						</div>
						<div className="footerSectionCover flex-1 footerLinks__wrap--child mt-4 lg:mt-0">
							...
							<ul className="footerSectionList flex lg:flex-col flex-wrap">
								{/* <li className='basis-[100%] md:basis-[33.33333333333%]'><a href="">Airbnb.org: disaster relief housing</a></li> */}
								<li className="basis-[100%] md:basis-[33.33333333333%]">
